...
(function (JTopo) {
	...
	MessageBus.prototype.unsubscribe = function (a) {
		...
		null != c && (this.messageMap[a] = null, delete this.messageMap[a], this.messageCount--)
	}
...
(function (JTopo) {
	...
	Stage.prototype.bindEvent = function (c) {
		...
		function d(b) {
			var c = JTopo.util.getEventPosition(b),
				d = JTopo.util.getOffsetPosition(n.canvas);
	...
	Stage.prototype.paint = function () {
		...
		this.childs.forEach(function (a) {
			1 == a.visible && a.repaint(graphics)
		})
...
(function (JTopo) {
			...
			for (var d = this.zIndexArray[c], e = this.zIndexMap[d], f = 0; f < e.length; f++) {
				...
				if (1 == this.paintAll || this.isVisiable(g)) {
					...
					1 == g.shadow && (b.shadowBlur = g.shadowBlur, b.shadowColor = g.shadowColor, b.shadowOffsetX = g.shadowOffsetX, b.shadowOffsetY = g.shadowOffsetY),
						g instanceof JTopo.InteractiveElement && (g.selected && 1 == g.showSelected && g.paintSelected(b), 1 == g.isMouseOver && g.paintMouseover(b)),
						g.paint(b),
						b.restore()
				}
			}
	...
	Scene.prototype.selectElement = function (a) {
		...
		if (null != b)
			if (a.target = b, b.mousedownHander(a), b.selectedHandler(a), this.notInSelectedNodes(b))
				a.ctrlKey || this.cancleAllSelected(), this.addToSelected(b);
			else {
	...
	Scene.prototype.mouseupHandler = function (b) {
		...
		var c = this.toSceneEvent(b);
		null != this.currentElement && (c.target = this.currentElement, this.currentElement.mouseupHandler(c)),
...
(function (JTopo) {
	...
	JTopo.Animate.gravity = aGravity
