...
Object.defineProperties(Node.prototype, {
  alarmColor: {
    ...
    set: function (b) {
      if (this._alarmColor = b, this.image != null) {
...
Node.prototype.paint = function (a) {
  if (this.image) {
    ...
    a.globalAlpha = b
  } else { a.beginPath(), a.fillStyle = 'rgba(' + this.fillColor + ',' + this.alpha + ')', this.borderRadius == null || this.borderRadius == 0 ? a.rect(-this.width / 2, -this.height / 2, this.width, this.height) : a.JTopoRoundRect(-this.width / 2, -this.height / 2, this.width, this.height, this.borderRadius), a.fill(), a.closePath() }
  this.paintText(a),
  this.paintBorder(a),
  this.paintCtrl(a),
...
Node.prototype.setImage = function (a, b) {
  ...
  } else { this.image = a, c.alarmColor = c.alarmColor == null ? '255,0,0' : c.alarmColor, b == 1 && this.setSize(a.width, a.height) }
}
